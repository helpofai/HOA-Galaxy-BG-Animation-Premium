...
class HOA_Galaxy_Background {
    ...
    public function settings_init() {
        ...
        add_settings_field(
            ...
            'hoa-galaxy-settings',
            'hoa_galaxy_stars',
            array('name' => 'star_colors', 'class' => 'color-field')
        );
        ...
        add_settings_field(
            ...
            'hoa-galaxy-settings',
            'hoa_galaxy_shooting',
            array('name' => 'shooting_colors', 'class' => 'color-field')
        );
    ...
    public function admin_enqueue_scripts($hook) {
        ...
        wp_enqueue_script('hoa-galaxy-admin', plugin_dir_url(__FILE__) . 'js/admin.js', array('wp-color-picker'), false, true);
    }
}
...
if (is_admin()) {
    $updater = new HOA_Galaxy_Updater(__FILE__);
